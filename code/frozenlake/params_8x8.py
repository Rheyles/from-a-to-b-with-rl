...
MAP_NAME = '8x8' # 4x4, 5x5_easy, 5x5_hard, 8x8
NEG_REWARD_LAKE = False

# Neural Network parameters
GAMMA = 0.8 # GAMMA is the discount factor of long-term reward
NN_SIZE = 64 # The size of the neural network

# DQN-specific parameters
DQN_EPS_START = 1 # EPS_START is the starting value of the exploration rate
DQN_EPS_END = 0.03 # EPS_END is the final value of exploration rate
DQN_EPS_DECAY = 8000 # EPS_DECAY is the typical number of steps to reduce epsilon (characteristic time of the exponential decay)
DQN_MEM_SIZE = 1500 # DQN_MEM_SIZE is the size of the ReplayMemory buffer
...
DQN_LR = 1e-4 # LR is the initial learning rate of the optimizer
