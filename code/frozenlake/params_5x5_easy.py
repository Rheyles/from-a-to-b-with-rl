...
MAP_NAME = '5x5_easy' # 4x4, 5x5_easy, 5x5_hard, 8x8
...
DQN_MEM_SIZE = 1000 # DQN_MEM_SIZE is the size of the ReplayMemory buffer
...
DQN_LR = 2e-3 # LR is the initial learning rate of the optimizer
...
DQN_SCHEDULER_MIN_LR = 3e-4 # The minimum learning rate that the scheduler can set
