...
NETWORK = 'ConvDQN2LayersBrice' 
           ...
           # LinearDQN, LinearA2C
           # ******* CAR RACE **********
           # ConvDQN_2layers_classic (from Manu), ConvDQN_2layers_small (from https://github.com/andywu0913/OpenAI-GYM-CarRacing-DQN/), ConvDQN2layersBrice (https://github.com/wiitt/DQN-Car-Racing)
...
MIN_LR = 2e-4   # How low it can (will) get due to the optimizer
